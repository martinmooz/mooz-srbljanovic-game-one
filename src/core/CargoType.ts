...
export class CargoTypeManager {
    private static cargoData: Record<CargoType, CargoInfo> = {
        [CargoType.PASSENGERS]: {
            ...
            baseValue: 70, // Reduced from 100
            color: '#FFFFFF',
            name: 'Passengers'
        },
        [CargoType.COAL]: {
            type: CargoType.COAL,
            baseValue: 140, // Reduced from 200
            color: '#2C2C2C',
            name: 'Coal'
        },
        [CargoType.IRON_ORE]: {
            type: CargoType.IRON_ORE,
            baseValue: 175, // Reduced from 250
            color: '#8B4513',
            name: 'Iron Ore'
        },
        [CargoType.STEEL]: {
            type: CargoType.STEEL,
            baseValue: 350, // Reduced from 500
            color: '#708090',
            name: 'Steel'
        },
        [CargoType.TOOLS]: {
            type: CargoType.TOOLS,
            baseValue: 560, // Reduced from 800
            color: '#DAA520',
            name: 'Tools'
        },
        [CargoType.GOODS]: {
            type: CargoType.GOODS,
            baseValue: 420, // Reduced from 600
            color: '#4682B4',
            name: 'Goods'
        },
        [CargoType.WOOD]: {
            type: CargoType.WOOD,
            baseValue: 100, // Reduced from 150
            color: '#8B4513',
            name: 'Wood'
        },
        [CargoType.LUMBER]: {
            type: CargoType.LUMBER,
            baseValue: 280, // Reduced from 400
            color: '#D2B48C',
            name: 'Lumber'
        },
        [CargoType.OIL]: {
            type: CargoType.OIL,
            baseValue: 250, // Reduced from 350
            color: '#1A1A1A',
            name: 'Oil'
        },
        [CargoType.GOLD]: {
            type: CargoType.GOLD,
            baseValue: 700, // Reduced from 1000
            color: '#FFD700',
            name: 'Gold'
        }
    };
